...
.publis1291:hover {
    ...
    <div class="row" >
        ...
        <div class="ask-question-input-part032">
              <h4>Ask Question</h4>
         <hr>
    <form onsubmit="return validate()" method="POST"  action="qstAct.php">
    <div class="question-title39">
        <span class="form-description433">Question-Title* </span>
        <input id ="qst_title"type="text" name="titleqst" class="question-ttile32" placeholder="Write Your Question Title">
    </div>
   <div class="categori49">
       <span class="form-description43305">Category* </span>
        <label>
        <input id="cat" list="browsers" name="categorie" class="list-category53"/></label>
...
<br>
        ...
        <div class="form-group">
            ...
            <textarea id ="msg" name="msg"  msg cols="30" rows="5" class="form-control" style="margin-top: 10px; background-color: rgb(255, 255, 255);"></textarea>
        </div>
    
        <div class="publish-button2389">   
                 <div style="display: none;"  class="message" id="err"></div>
            <button type="submit" class="publis1291" name="publish">Publish your Question</button>
        </div>
</form>
